...
def run_as_console():
    logger.info("SysID9 Agent starting...")
...
def run_as_service():
    from sysid9_agent.service import SysID9Service
...
def main():
    os.makedirs(os.path.join(os.environ.get("PROGRAMDATA", "C:\\ProgramData"), "SysID9"), exist_ok=True)
